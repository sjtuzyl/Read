...
// usage: log_('inside coolFunc',this,arguments);
...
//   vjs.log_('unloadingTech')
//   this.unloadTech();
//   vjs.log_('unloadedTech')
//   if (betweenFn) { betweenFn.call(); }
//   vjs.log_('LoadingTech')
...
vjs.Player.prototype.trackProgress = function(){
  ...
  this.progressInterval = setInterval(vjs.bind(this, function(){
    ...
    // log_(this.cache_.bufferEnd, this.buffered().end(0), this.duration())
...
vjs.ChaptersTrackMenuItem.prototype.update = function(){
  ...
  // vjs.log_(currentTime, cue.startTime);
